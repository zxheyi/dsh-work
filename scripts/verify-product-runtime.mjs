...
import { verifySource, verifyPublishedPackage, verifyNodeArchive } from './runtime-provenance.mjs'
...
export function verifyProductRuntime({ source, tarball, node, nodeArchive }) {
  ...
  const nodeSHA256 = checked('node-provenance-failed', () => verifyNodeArchive(nodeArchive, node, baseline.runtime))
