...
- The current [desktop entry](../../apps/desktop/main.ts) creates a temporary Home per launch. That avoids reusing old state but cannot reconcile or preserve a clean Profile across launches.
