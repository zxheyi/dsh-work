...
> **Current status:** Electron, the official Harness alpha.2 runtime boundary, the external guardian, and persistent Profile-generation recovery have passed native macOS/Windows verification. There is no packaged release ready for daily use.
